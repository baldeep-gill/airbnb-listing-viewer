...
public class AirbnbListing {
     ...
     * The names are shortened (Croydon -> CROY)
     */
    ...
    /**
     * The full neighbourhood name, Croydon instead of CROY
     */
    private String neighbourhoodFull;
    ...
    double reviewsPerMonth, int calculatedHostListingsCount,
    int availability365, String neighbourhoodFull) {
        this.id = id;
        this.name = name;
        ...
        this.neighbourhoodFull = neighbourhoodFull;
    }
    ...
    public String getNeighbourhoodFull() {
        return neighbourhoodFull;
    }
    ...
    public String toString() {
        ...
        ", neighbourhoodFull=" + neighbourhoodFull +
        '}';
    }
}
